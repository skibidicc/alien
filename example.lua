...
local library =loadstring(game:HttpGet("https://raw.githubusercontent.com/skibidicc/alien/refs/heads/main/Source.lua",true))()


local window = library:new({name = "Alien", sub = ".raper", offset = 0, size = Vector2.new(600, 650)})
local pages = {
